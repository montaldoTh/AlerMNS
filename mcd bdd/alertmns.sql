...
--
-- Hôte : localhost
-- Généré le : mer. 04 mai 2022 à 08:40
...
CREATE TABLE `message_envoye_users` (
  `id_message` int(11) NOT NULL,
...
INSERT INTO `users` (`id`, `lastName`, `firstName`, `email`, `creation_date`, `password`, `type_user`, `id_type_user`) VALUES
...
ALTER TABLE `appartient`
  ADD PRIMARY KEY (`id_users`,`id_groupe`),
  ADD KEY `ID_GOUPE` (`id_groupe`);

--
-- Index pour la table `expedier`
--
ALTER TABLE `expedier`
  ADD PRIMARY KEY (`id_groupe`,`id_message`),
...
--
-- Index pour la table `message_envoye_users`
--
...
--
-- Index pour la table `read`
--
ALTER TABLE `read`
  ADD PRIMARY KEY (`id_users`,`id_message`),
  ADD KEY `ID_MESSAGE` (`id_message`);
...
--
-- AUTO_INCREMENT pour la table `groupe_type`
--
ALTER TABLE `groupe_type`
  MODIFY `id_type` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `message_envoye_users`
--
ALTER TABLE `message_envoye_users`
...
--
ALTER TABLE `type_user`
  MODIFY `id_type_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `message_envoye_users`
  ADD CONSTRAINT `message_envoye_users_ibfk_1` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`);
...
ALTER TABLE `read`
  ...
  ADD CONSTRAINT `read_ibfk_2` FOREIGN KEY (`id_message`) REFERENCES `message_envoye_users` (`id_message`);
